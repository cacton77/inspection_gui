...
class Tf2MessageFilterOLD(SimpleFilter):

    """Stores a message unless corresponding transforms is
    available
    """

    def __init__(self, node, input_filter, base_frame, target_frame,
                 queue_size=500):
        SimpleFilter.__init__(self)
    ...
    def connectInput(self, input_filter):
        self.incoming_connection = input_filter.registerCallback(
            self.input_callback)
