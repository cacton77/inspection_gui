...
class RosThread(Node):
    ...
    def compressed_image_callback(self, msg):
        ...
        self.servo_twist.twist.angular.x = velocity[3]
        self.servo_twist.twist.angular.y = velocity[4]
        self.servo_twist.twist.angular.z = velocity[5]
